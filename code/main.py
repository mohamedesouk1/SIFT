...
def main():
    ...
    # 3) SIFT implimentation

    print("Getting features...")

    image1_features,x1,y1 = student.get_features(image1, feature_width)
    image2_features,x2,y2 = student.get_features(image2, feature_width)
    
    print("number of keypoints",len(x1))
    print("features extracted from image 1",image1_features.shape)
    print("features extracted from image 2",image2_features.shape)
